...
// Render - using adirik/interior-design (verified working)
// with very low prompt_strength to preserve original room
  ...
  try {
    ...
    const body = {
      ...
      input: {
        image: input.image,
        prompt: input.prompt,
        negative_prompt: "changing wall color, painting walls, removing furniture, replacing furniture, new furniture, cartoon, deformed, blurry, watermark, text",
        guidance_scale: 7,
        prompt_strength: 0.3,
